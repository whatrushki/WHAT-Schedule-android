...
object RKSILessonsSchedule {
    val COMMON = listOf(
        LessonTimeDto(1, LocalTime.of(8, 0), LocalTime.of(9, 30)),
        LessonTimeDto(2, LocalTime.of(9, 40), LocalTime.of(11, 10)),
        LessonTimeDto(3, LocalTime.of(11, 30), LocalTime.of(13, 0)),
        LessonTimeDto(4, LocalTime.of(13, 10), LocalTime.of(14, 40)),
        LessonTimeDto(5, LocalTime.of(15, 0), LocalTime.of(16, 30)),
        LessonTimeDto(6, LocalTime.of(16, 40), LocalTime.of(18, 10)),
        LessonTimeDto(7, LocalTime.of(18, 20), LocalTime.of(19, 50))
    )

    val SHORTENED = listOf(
        LessonTimeDto(1, LocalTime.of(8, 0), LocalTime.of(8, 50)),
        LessonTimeDto(2, LocalTime.of(9, 0), LocalTime.of(9, 50)),
        LessonTimeDto(3, LocalTime.of(10, 0), LocalTime.of(10, 50)),
        LessonTimeDto(4, LocalTime.of(11, 0), LocalTime.of(11, 50)),
        LessonTimeDto(5, LocalTime.of(12, 0), LocalTime.of(12, 50)),
        LessonTimeDto(6, LocalTime.of(13, 0), LocalTime.of(13, 50)),
        LessonTimeDto(7, LocalTime.of(14, 0), LocalTime.of(14, 50))
    )
    ...
    val WITH_CLASS_HOUR = listOf(
        ...
        LessonTimeDto(2, LocalTime.of(9, 40), LocalTime.of(11, 10)),
        LessonTimeDto(3, LocalTime.of(11, 30), LocalTime.of(13, 0)),
        LessonTimeDto(0, LocalTime.of(13, 5), LocalTime.of(14, 5)),
        LessonTimeDto(4, LocalTime.of(14, 10), LocalTime.of(15, 40)),
        LessonTimeDto(5, LocalTime.of(16, 0), LocalTime.of(17, 30)),
        LessonTimeDto(6, LocalTime.of(17, 40), LocalTime.of(19, 10))
    )
}
...
class RKSIScheduleClient(
    ...
    private suspend fun fetchSchedule(
        ...
        val daySchedules = dayElements.map { dayElement ->
            ...
            val date = if (dateParts.size >= 2) {
                val dayNum = dateParts[0].toIntOrNull() ?: LocalDate.now().dayOfMonth
                val monthNum = parseMonth(dateParts[1]).takeIf { it in 1..12 } ?: LocalDate.now().monthValue
                try {
                    LocalDate.of(LocalDate.now().year, monthNum, dayNum)
                } catch (_: Exception) {
                    LocalDate.now()
                }
            } else {
            ...
            val scheduleType = when {
                ...
                lessons.any { it.startTime == LocalTime.of(8, 0) && it.endTime == LocalTime.of(8, 50) } -> LessonsScheduleTypeDto.SHORTENED
    ...
    private suspend fun fetchReplacements(target: String, isGroup: Boolean): List<LessonDto> {
        ...
        val relevantFiles = allFiles.filter { file ->
            ...
            if (parts.size == 2) {
                val fileDate = LocalDate.of(today.year, parts[1], parts[0])
                file.additionalData["date"] = fileDate
                fileDate >= today.minusDays(1)
            } else false
        }
        ...
        val parsedLists = coroutineScope {
            relevantFiles.map { file ->
                async(Dispatchers.IO) {
                    ...
                    try {
                        RKSIReplacementsParser.parseFromStream(ByteArrayInputStream(bytes), columns, date, predicate)
                    } catch (e: Exception) {
